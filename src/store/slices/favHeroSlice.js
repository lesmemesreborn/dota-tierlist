...
const favHeroSlice = createSlice({
    name: 'favHero',
    initialState,
    reducers: {
        ...
        setFavHeroes: (state, {payload}) => {
          state.favoriteHeroData = [payload, ...state.favoriteHeroData]
        }
    }
})

export const {setAllHeroes, setFavHeroes} = favHeroSlice
export default favHeroSlice.reducer